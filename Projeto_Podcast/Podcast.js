// ==========================================
        // CONFIGURAÇÃO DOS PODCASTS
        // ==========================================
        
        /* 
         * ARRAY DE PODCASTS: Adicione os links dos seus arquivos de áudio aqui
         * Substitua "LINK_DO_AUDIO_EPISODIO_X.mp3" pelos URLs reais dos seus podcasts
         */
        const podcasts = [
            {
                title: "A Pedra Filosofal do Python",
                audio: "../Audios_Podcast/Pagina1_EP1.mp3"  // SUBSTITUA com link real
            },
            {
                title: "A Câmara Secreta das Funções",
                audio: "LINK_DO_AUDIO_EPISODIO_2.mp3"  // SUBSTITUA com link real
            },
            {
                title: "O Prisioneiro de Azkaban - Loops e Condições",
                audio: "LINK_DO_AUDIO_EPISODIO_3.mp3"  // SUBSTITUA com link real
            },
            {
                title: "O Cálice de Fogo - Classes e Objetos",
                audio: "LINK_DO_AUDIO_EPISODIO_4.mp3"  // SUBSTITUA com link real
            },
            {
                title: "A Ordem da Fênix - Bibliotecas e Módulos",
                audio: "LINK_DO_AUDIO_EPISODIO_5.mp3"  // SUBSTITUA com link real
            }
        ];
        ...
        window.onload = function() {
            ...
            backgroundMusic.volume = 0.5;  // Volume aumenta/diminui
